  ...
  routes: [
    ...
    { path: '/login', name: 'login', component: () => import('./views/login.vue') },
    {
      ...
      children: [
        ...
        { path: '/order/add', component: () => import('./views/order/editOrder.vue') },
        ...
        { path: '/customer/add', component: () => import('./views/customer/editCustomer.vue') },
        { path: '/customer/edit/:customerId', component: () => import('./views/customer/editCustomer.vue') },
        { path: '/customer/view/:viewId', component: () => import('./views/customer/editCustomer.vue') },
