  ...
  <div class="page-material">
    <div style="overflow:hidden;">
      <el-breadcrumb separator-class="el-icon-arrow-right" style="margin:20px 0;float:left;">
        ...
        <el-breadcrumb-item>修改物料</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <el-form label-width="100px" style="width:400px;" :model="form" :rules="rules" ref="form">
      ...
      <div style="text-align:left;">
        <el-form-item>
          <el-button type="primary" @click="modifyMat">立即修改</el-button>
        </el-form-item>
      </div>
...
export default {
  ...
  mounted() {
    var that = this;
    that.materialId = that.$route.params.materialId * 1;
    axios
      .get("/material/getMaterialById/" + that.materialId)
    ...
    modifyMat() {
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          axios
            .post("/material/updateMaterial", param)
            .then(function(response) {
